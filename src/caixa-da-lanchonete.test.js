...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        ['com forma de pagamento inválida', 'especie', 'Forma de pagamento inválida!', ['salgado, 1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));

    test.each([
        ['dinheiro', 'R$ 5,89', ['suco,1']],
        ['credito', 'R$ 9,79', ['combo1,1']],
        ['debito', 'R$ 7,25', ['salgado,1']],
        ['credito', 'R$ 22,66', ['cafe,1', 'sanduiche,2', 'queijo,3']],
        ['debito', 'R$ 21,20', ['suco,1', 'combo2,2']],
    ])('compra variadas, simples, com varios itens e multiplas quantidades em %p deve resultar em %p', validaTeste);
    ...
    test.each([
        ...
        ['debito', 'R$ 6,20', ['suco,1']],
        ['dinheiro', 'R$ 8,07', ['sanduiche,1', 'queijo,1']],
        ['debito', 'R$ 7,25', ['salgado,1']],
        ['credito', 'R$ 9,79', ['combo1,1']],
    ...
    test.each([
        ['com carrinho vazio', 'dinheiro', 'Não há itens no carrinho de compra!', []],
        ['com um valor', 'credito', 'Item inválido!', ['1']],                                         
        ['com código inexistente', 'debito', 'Item inválido!', ['cerveja, 1']],
